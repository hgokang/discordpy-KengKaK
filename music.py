...
class Music(commands.Cog, wavelink.WavelinkMixin):
    ...
    @commands.command(name="shuffle" ,aliases=["สุ่ม"])
    ...
    @commands.group(name="volume", invoke_without_command=True, aliases=["s", "S"])
    ...
    async def skipto_command(self, ctx, index: int):
        ...
        await player.stop()
        await ctx.send(f"เล่นเพลงที่ {index}.")
